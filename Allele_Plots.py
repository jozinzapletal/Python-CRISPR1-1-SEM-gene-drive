            ...
            for g1 in male_gammaList:
                for g2 in female_gammaList:
                    ...
                    for b in alleleList:
                        ...
                        plt.legend(loc='right', prop={'size': 6}, frameon=False, bbox_to_anchor=(1.05, 0.45))

                        plt.text(generations / 3, 1.05, 'male (α = ' + str(a1) + ', γ = ' + str(g1) + ')\n' +
                                                        'female (α = ' + str(a2) + ', γ = ' + str(g2) + ')',
                                 color='black', fontsize=ft)

                        plt.subplots_adjust(left=0.14, bottom=0.16, right=0.95, top=0.95, wspace=0, hspace=0)
