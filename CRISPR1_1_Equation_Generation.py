    ...
    for result in two_allele_combinations:
        ...
        for male in two_allele_combinations:
            ...
            if (maleWcount == 1) and (maleGcount == 1):
                prob_gene_male['w'] = {'prob': '((alpha1+((beta1+gamma1)*(1-q1)))/2)'}
                prob_gene_male['v'] = {'prob': '(alpha1/2)'}
                prob_gene_male['u'] = {'prob': '((delta1*(1-P1)*q1*(beta1+gamma1))/2)'}
                prob_gene_male['r'] = {'prob': '(((1-delta1)*(1-P1)*q1*(beta1+gamma1))/2)'}
                prob_gene_male['g'] = {'prob': '((beta1*(1+q1*P1))/2)'}
                prob_gene_male['s'] = {'prob': '((gamma1*(1+q1*P1))/2)'}
                ...
                prob_gene_male['v'] = {'prob': '((alpha1+1)/2)'}
            ...
            for female in two_allele_combinations:
                ...
                if (femaleWcount == 1) and (femaleGcount == 1):
                    prob_gene_female['w'] = {'prob': '((alpha2+((beta2+gamma2)*(1-q2)))/2)'}
                    prob_gene_female['v'] = {'prob': '(alpha2/2)'}
                    prob_gene_female['u'] = {'prob': '((delta2*(1-P2)*q2*(beta2+gamma2))/2)'}
                    prob_gene_female['r'] = {'prob': '(((1-delta2)*(1-P2)*q2*(beta2+gamma2))/2)'}
                    prob_gene_female['g'] = {'prob': '((beta2*(1+q2*P2))/2)'}
                    prob_gene_female['s'] = {'prob': '((gamma2*(1+q2*P2))/2)'}
                    ...
                    prob_gene_female['v'] = {'prob': '((alpha2+1)/2)'}
                    ...
                    prob_gene_female['v'] = {'prob': '(alpha2)'}
